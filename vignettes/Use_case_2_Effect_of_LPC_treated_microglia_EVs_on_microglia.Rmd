...
```{r 1}
LPS_microglia_EVs <- read.csv(url("https://zenodo.org/records/17391831/files/LPS_microglia_EVs.csv"), stringsAsFactors = FALSE)
```
...
```{r 3}
receiving_microglia_expression <- readRDS(url("https://zenodo.org/records/17581185/files/receiving_microglia_expression.rds"))
```
