...
#'
#' A data.frame/tibble describing EV_cargo-receptor interactions and the data source describing this interaction.
#'
#' @format A data frame/tibble
#' \describe{
#'   \item{from}{the EV_cargo}
#'   \item{to}{receptor of the EV_cargo}
...
#'   }
#'   \item{from}{Gene symbol(s) of EV_cargo(s) by which the cells were treated}
...
#'   \item{network}{Network layer to which the data source belongs: EV_cargo_receptor, signaling or gene_regulatory}
#'   }
#'
